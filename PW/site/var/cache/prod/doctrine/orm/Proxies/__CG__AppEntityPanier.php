...
class Panier extends \App\Entity\Panier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entity\\Panier' . "\0" . 'User', '' . "\0" . 'App\\Entity\\Panier' . "\0" . 'Produit', '' . "\0" . 'App\\Entity\\Panier' . "\0" . 'quantite'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProduit(?\App\Entity\Produit $produit): \App\Entity\Panier
    {
