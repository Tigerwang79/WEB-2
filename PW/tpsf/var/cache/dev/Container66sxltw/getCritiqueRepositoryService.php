...
{
    /**
     * Gets the private 'App\Repository\CritiqueRepository' shared autowired service.
     *
     * @return \App\Repository\CritiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CritiqueRepository.php';

        return $container->privates['App\\Repository\\CritiqueRepository'] = new \App\Repository\CritiqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
