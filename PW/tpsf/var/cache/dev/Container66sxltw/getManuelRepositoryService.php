 ...
 */
class getManuelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ManuelRepository' shared autowired service.
     *
     * @return \App\Repository\ManuelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ManuelRepository.php';

        return $container->privates['App\\Repository\\ManuelRepository'] = new \App\Repository\ManuelRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
